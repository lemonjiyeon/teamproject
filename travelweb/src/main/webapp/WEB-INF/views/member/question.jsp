				...
				<form name="form" id="form" method="post">
					...
					<div class="content" id="contit_con_titletent">
						...
						<table class="tbl_basic">
							...
							<tbody>
								<tr>
									<th><label>여행타입<span class="ico_tbl_must"
											title="필수입력"></span></label></th>
									<td>
										<div class="tbl_line">
											<ul class="list_align_category">

												<li><span class="form_block"> <input
														type="radio" id="tourjeju" name="tourjeju" value="jeju"
														onclick="fn_setTravrvType('FDMA');"> <label
														for="tourjeju"><span></span>국내여행[제주]</label></span></li>

												<li><span class="form_block"> <input
														type="radio" id="tourdomestic" name="tourdomestic"
														value="domestic" onclick="fn_setTravrvType('FDMI');">
														<label for="tourdomestic"><span></span>국내여행[내륙/섬]</label></span></li>

												<li><span class="form_block"> <input
														type="radio" id="tourtheme" name="tourtheme" value="theme"
								...
								<tr id="tr_Item_FDMI_3"
									...
									<td>
										<div class="tbl_line">
											<ul class="list_one_category">
												<li><span class="form_block"> <input
														type="radio" name="rdo_trafficServ"
														id="rdo_Item_FDMI_3_11" value="11"> <label
														for="rdo_Item_FDMI_3_11"><span></span>항공</label>
												</span></li>
												<li><span class="form_block"> <input
														type="radio" name="rdo_trafficServ"
														id="rdo_Item_FDMI_3_12" value="12"> <label
														for="rdo_Item_FDMI_3_12"><span></span>버스</label>
												</span></li>
												<li class="last"><span class="form_block"> <input
														type="radio" name="rdo_trafficServ"
														id="rdo_Item_FDMI_3_13" value="13"> <label
														for="rdo_Item_FDMI_3_13"><span></span>렌트</label>
												</span></li>
											</ul>
										</div>
									</td>
