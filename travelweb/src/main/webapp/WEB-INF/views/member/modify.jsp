...
<script>
	...
	})(window, document, 'script', 'dataLayer', 'GTM-KSPKF2F');
</script>
...
<script type="text/javascript">
	!function(q, g, r, a, p, h, js) {
		if (q.qg)
			return;
		js = q.qg = function() {
			js.callmethod ? js.callmethod.call(js, arguments) : js.queue
					.push(arguments);
		};
		js.queue = [];
		p = g.createElement(r);
		...
		h.parentNode.insertBefore(p, h);
			...
			(window, document, 'script',
					'//cdn.qgr.ph/qgraph.ca99de184d977f9e3317.js');
</script>
...
<body>
	...
	<script type="text/javascript">
		function InitToggle(v1) {
			$("#" + v1).attr("class", "lnb_menu on_open");
			$("#" + v1 + " .lnb_sub").show();
			$("#" + v1 + " .lnb_sub").attr("class", "lnb_sub on_open");
			var lnb = 'psn';
			$("#" + lnb).attr("class", "active");
		}
	</script>
	<!-- //lnb -->
			...
			<table class="tbl_basic">
				...
				<tr>
					...
					<td><input type="text" name="custNmKor" id="txtName"
						value="" title="이름 입력" placeholder="예) 주노랑"></td>
...
<script type="text/javascript">
	...
	wptg_tagscript_vars.push((function() {
		return {
			wp_hcuid : "mylovetjrl@naver.com", /*고객넘버 등 Unique ID (ex. 로그인  ID, 고객넘버 등 )를 암호화하여 대입.
