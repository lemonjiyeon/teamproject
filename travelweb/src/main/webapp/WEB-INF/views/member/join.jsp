				...
				<div class="block">
					...
					<form id="frm" method="post" action="" autocomplete="on">
						...
						<input type="hidden" id="joinType" name="joinType" value="" /> <input
							...
							<select class="nosel" title="도메인 선택 혹은 직접 입력" id="selEmailList"
							tabindex="2">
						...
						</span> <span class="input_row"> <span class="input_grp item">
								<p class="txt_ emp_blue">본인 소유의 이메일 계정이 아닐 경우 임의로 삭제될 수
									있습니다.</p>
						</span>
						...
						<span class="input_row"> <span class="input_grp item">
							...
							<span class="input_grp">
								<ul class="form_align">
									...
									<li><span class="rio_circle"><input type="radio"
											id="reten1" name="reten" value="Y3"><label
											for="reten1"><span></span>3년</label></span></li>

									<li><span class="rio_circle"><input type="radio"
											id="reten2" name="reten" value="Y5"><label
											for="reten2"><span></span>5년</label></span></li>

									<li><span class="rio_circle"><input type="radio"
											id="reten3" name="reten" value="Y0"><label
											for="reten3"><span></span>회원 탈퇴 시 까지</label></span></li>
