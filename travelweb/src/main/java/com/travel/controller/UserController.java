...
public class UserController {
	...
	public String userModifyGET(HttpServletRequest req, Model model, UserVO userVO) throws Exception {
		...
		UserVO modifyUser = userService.usermodifyGET(user.getUserid());
		
		model.addAttribute("modifyid",modifyUser.getUserid());
		model.addAttribute("modifypwd",modifyUser.getUPwd());
		model.addAttribute("modifyname",modifyUser.getUName());
		model.addAttribute("modifytel",modifyUser.getUTel());
		model.addAttribute("modifybirth",modifyUser.getUBirth());
	...
	public String userModifPOST(@RequestBody UserVO userVO) throws Exception{
